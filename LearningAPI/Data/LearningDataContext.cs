...
namespace LearningAPI.Data
{
    public class LearningDataContext : DbContext
    {
        ...
        {
            modelBuilder.Entity<TodoItem>().Property(p => p.Description)
                .HasMaxLength(500);
            ...
            modelBuilder.Entity<LearningItem>()
                .HasData(
                    ...
                    new LearningItem { Id = 2, Topic = "Learn Terraform", Competency = "Conscious Competence", Notes = "Watched some good videos. Tried it out. It's cool" }
                );
        }
    }
}
